...
class AtomicLogAnalyzer:
    ...
    def generate_html_report(self, output_file: str = None):
        ...
        if not output_file:
            ...
            output_file = f"{self.report_dir}/security_validation_report_linux_{timestamp}.html"
...
<body>
    <div class="header">
        ...
        <p>测试环境: Linux 系统 | 工具: goart-linux</p>
...
"""
    ...
    def generate_excel_report(self, output_file: str = None):
        ...
        if not output_file:
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            output_file = f"{self.report_dir}/security_validation_report_linux_{timestamp}.xlsx"
    ...
    def generate_text_report(self, output_file: str = None):
        ...
        if not output_file:
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            output_file = f"{self.report_dir}/security_validation_report_linux_{timestamp}.txt"
    ...
    def generate_docx_report(self, output_file: str = None):
        ...
        if not output_file:
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            output_file = f"{self.report_dir}/security_validation_report_linux_{timestamp}.docx"
        ...
        overview_text = (
            ...
            f"涵盖 {stats['techniques_tested']} 种攻击技术。测试范围覆盖 Linux 系统环境，使用 Atomic Red Team "
...
def main():
    ...
    if args.output:
        ...
        base_name = f"security_validation_report_linux_{timestamp}"
